import { getDynamoDBAuthUsecase, initializeWSBaileysUsecase, sendMessageUsecase } from './src/usecases/index.mjs'
...
(async () => {
    try {
        ...
        if (!hasValidSession) {
            console.log('[*] No hay sesión guardada. Se mostrará el QR para escanear...');
        }
